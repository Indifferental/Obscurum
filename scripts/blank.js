        ...
        function themeSettings() {
                ...
                let p2_el6 = element('div', 'radElement-pageElement p2_elem_6', pageHolder_2);
                        ...
                        p2_el6_input.addEventListener('input', function (event) {
                                ...
                                let p2_el6_input_value = hexToRgb(document.querySelector('.radElement-pageElementInput.p2_elem_6_input').value.replace('#', '')).replace(/,/g, ' ');
                ...
                let p2_el7 = element('div', 'radElement-pageElement p2_elem_7', pageHolder_2);
                        ...
                        p2_el7_input.addEventListener('input', function (event) {
                                ...
                                let p2_el7_input_value = hexToRgb(document.querySelector('.radElement-pageElementInput.p2_elem_7_input').value.replace('#', '')).replace(/,/g, ' ');
