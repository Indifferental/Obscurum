...
(function() {
        ...
        function styleSheet() {
                ...
                const elements = [
                        ...
                        {
                                selector: 'body, .BattleComponentStyle-canvasContainer > .-container',
                                style: `
                        ...
                        {
                                selector: '.radElement-startTextNode',
                                style: `
                                        position: absolute;
                                        display: flex;
                                        ...
                                        animation: windowDown 1s ease-in-out 2s forwards;
                                `
                        },

                        {
                                selector: '.radElement-startText',
                                style: `
                                        font-size: 1.5em;
                        ...
                        {
                                selector: '.radElement-startTextVersion',
                                style: `
                        ...
                        {
                                selector: '.radElement-rankBox',
                                style: `
                                        position: fixed;
                                        top: 1em;
                                        width: 10em;
                                        height: 10em;
                                        animation: startRankRotate 10s ease-in-out 1s forwards;
                                `
                        },
                        ...
                        {
                                selector: '.radElement-homeButton',
                                style: `
                                        border-top-right-radius: unset !important;
                                        corner-top-right-shape: unset !important;
                        ...
                        {
                                selector: '.radElement-homeButton:hover',
                                style: `
                                        background: var(--general-background-hover);
                                `
                        },
                        ...
                        {
                                selector: '.radElement-homeButtonImage',
                                style: `
                                        background-color: rgb(255 255 255 / 30%);
                                        mask-image: url("https://s.eu.tankionline.com/static/images/logOut.29b47580.svg");
                                        mask-position: center;
                                        mask-repeat: no-repeat;
                                        mask-size: contain;
                        ...
                        {
                                selector: '.radElement-homeButton:hover > .radElement-homeButtonImage',
                                style: `
                                        background-color: white;
                                `
                        },
                        ...
                        {
                                selector: '.radElement-elementsGroup',
                                style: `
                                        display: flex;
                                        justify-content: space-between;
                        ...
                        {
                                selector: '.radElement-elementsGroup > .radElement-pageElement',
                                style: `
                                        width: 50%;
                                        height: inherit;
                                        margin-bottom: unset;
                        ...
                        {
                                selector: '.radElement-pageElementToggle',
                                style: `
                                        background: rgb(255 255 255 / 20%);
                        ...
                        {
                                selector: '.radElement-pageElementToggleInner',
                                style: `
                        ...
                        {
                                selector: '.radElement-pageElementTip',
                                style: `
                        ...
                        {
                                selector: '.radElement-pageElementText',
                                style: `
                                `
                        },

                        {
                                selector: `.p5_elem_1_header,
                                           .p5_elem_2_text,
                                           .p5_elem_4_text`,
                                style: `
                                        text-transform: uppercase;
                        ...
                        {
                                selector: '.BreadcrumbsComponentStyle-rootTitle',
                                style: `
                        ...
                        {
                                selector: '.BreadcrumbsComponentStyle-rootTitle > span',
                                style: `
                        ...
                        {
                                selector: '.BattlePickComponentStyle-commonStyleBlock:hover',
                                style: `
                                       outline: var(--general-outline-hover);
                                `
                        },
                        ...
                        {
                                selector: `.BattlePickComponentStyle-commonStyleBlock > .BattlePickComponentStyle-cardImg,
                                           .BattlePickComponentStyle-commonStyleBlock > .BattlePickComponentStyle-cardImgEvent`,
                                style: `
                        ...
                        {
                                selector: `.BattlePickComponentStyle-commonStyleBlock:hover > .BattlePickComponentStyle-cardImg,
                                           .BattlePickComponentStyle-commonStyleBlock:hover > .BattlePickComponentStyle-cardImgEvent`,
                                style: `
                                        opacity: 1;
                                        transform: scale(1.1);
                                `
                        ...
                        {
                                selector: `.BattlePickComponentStyle-cardContentLeft > div:nth-child(1),
                                           .BattlePickComponentStyle-cardContentRight > div:nth-child(2)`,
                                style: `
                                        border-top-right-radius: 2em;
                                        corner-top-right-shape: bevel;
                                        border-bottom-left-radius: 2em;
                        ...
                        {
                                selector: `.BattlePickComponentStyle-cardContentLeft > div:nth-child(2),
                                           .BattlePickComponentStyle-cardContentRight > div:nth-child(1)`,
                                style: `
                                        border-top-left-radius: 2em;
                                        corner-top-left-shape: bevel;
                                        border-bottom-right-radius: 2em;
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard',
                                style: `
                                        background: rgb(0 0 0 / 50%);
                                        box-shadow: var(--general-box-shadow) !important;
                                        outline: var(--general-outline);
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard:hover',
                                style: `
                                        outline: var(--general-outline-hover);
                                `
                        },
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard > .-backgroundImageCover',
                                style: `
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard:hover > .-backgroundImageCover',
                                style: `
                                        opacity: 1;
                                        transform: scale(1.1);
                                `
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-cardName > h2',
                                style: `
                                        color: rgb(255 255 255 / 30%);
                                        text-shadow: 0 0 6px black;
                                        font-size: 1.75em;
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-cardName > div',
                                style: `
                                        background: transparent !important;
                                        margin: unset;
                                `
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-cardName > div > p',
                                style: `
                                        color: rgb(255 255 255 / 30%);
                                        text-shadow: 0 0 6px black;
                                        font-size: 1.75em;
                        ...
                        {
                                selector: `.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard:hover > .ScrollingCardsComponentStyle-cardName > h2,
                                           .ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard:hover > .ScrollingCardsComponentStyle-cardName > div > p`,
                                style: `
                                        color: white;
                                `
                        },
                        ...
                        {
                                selector: '.ScrollingCardsComponentStyle-scrollCardPick > .ScrollingCardsComponentStyle-scrollCard:hover > .ScrollingCardsComponentStyle-cardDescription',
                                style: `
                                        bottom: 2em;
                                        opacity: 1;
                                `
                        ...
                        {
                                selector: '.ProBattlesComponentStyle-mainContainer > div:nth-child(3) > .BattleInfoComponentStyle-selectBattle',
                                style: `
                                        border-top-left-radius: inherit;
                                        corner-top-left-shape: inherit;
                                        opacity: 0.1;
                        ...
                        {
                                selector: '.ProBattlesComponentStyle-mainContainer > div:nth-child(3) > .BattleInfoComponentStyle-caption',
                                style: `
                                        color: white;
                                        opacity: 0.25;
                                `
...

                        {
                                ...
                                style: `
                                        background: linear-gradient(90deg, rgb(0 136 255 / 20%) 20%, rgb(0 0 0 / 20%) 40%);
                                        outline: 1px solid rgb(255 255 255 / 10%);
                                        box-shadow: unset !important;
                                        border-radius: unset;
                                        border-bottom-right-radius: 0.75em;
...

                        {
                                ...
                                style: `
                                        background: linear-gradient(90deg, rgb(0 136 255 / 20%) 20%, rgb(255 255 255 / 10%) 40%) !important;
                                `
                        },
                        ...
                        {
                                selector: '.BattleTabStatisticComponentStyle-gsCell',
                                style: `
                ...
                let cssKeyframes = document.createElement('style');
                    ...
                    cssKeyframes.className = 'radiant-keyframesArray'

                globalKeyframes.forEach((keyframe) => {
        ...
        function startText() {
                ...
                let textNode = element('div', 'radElement-startTextNode', document.body);

                let textBox = element('span', 'radElement-startText', textNode);
                ...
                if (localStorage.getItem('obscLocalStorageVariable-nickname')) {
                        ...
                        if (language == 'RU') {
                                ...
                                textBox.innerHTML = `Добро пожаловать, ${localStorage.getItem('radiant-nickname')}`

                        } else {

                                textBox.innerHTML = `Welcome, ${localStorage.getItem('radiant-nickname')}`

                        };

                };

                let versionBox = element('span', 'radElement-startTextVersion', textNode);

                    versionBox.innerHTML = `Radiant ${version}`

                let rankBox = element('img', 'radElement-rankBox', textNode);

                    rankBox.src = localStorage.getItem('radiant-rank');
        ...
        function themeSettings() {
                ...
                var settingsSelectors = [

                        {
                                selector: `#app-root > .-visible,
                                           ...
                                           .UserScoreComponentStyle-blockRightPanel > div:nth-child(3),
                ...
                let homeButton = element('div', 'radElement-homeButton', document.querySelector('.UserScoreComponentStyle-blockRightPanel'));

                let homeButtonImage = element('div', 'radElement-homeButtonImage', homeButton);
                ...
                let p1_gr1 = element('div', 'radElement-elementsGroup p1_group_1', pageHolder_1);

                let p1_el1 = element('div', 'radElement-pageElement p1_elem_1', p1_gr1);
                        ...
                        let p1_el1_input = element('input', 'radElement-pageElementInput p1_elem_1_input', p1_el1);
                            ...
                            p1_el1_input.value = '#000000'

                        let p1_el1_input_span = element('span', 'radElement-pageElementInputValue p1_elem_1_value', p1_el1);

                            p1_el1_input_span.innerHTML = hexToRgb(p1_el1_input.value.replace('#', '')).replace(/,/g, ' ');

                        p1_el1_input.addEventListener('input', function (event) {

                                let p1_el1_input_value = hexToRgb(p1_el1_input.value.replace('#', '')).replace(/,/g, ' ');
                                ...
                                localStorage.setItem('radiantValue-defaultBackgroundValue-hex', p1_el1_input.value);
                        ...
                        if (localStorage.getItem('radiantValue-defaultBackgroundValue')) {
                                ...
                                p1_el1_input.value = localStorage.getItem('radiantValue-defaultBackgroundValue-hex');

                        };

                let p1_el2 = element('div', 'radElement-pageElement p1_elem_2', p1_gr1);

                        let p1_el2_span = element('span', 'radElement-pageElementSpan p1_elem_2_span', p1_el2);

                            p1_el2_span.innerHTML = 'Прозрачность фона элементов'
                        ...
                        let p1_el2_setting = element('input', 'radElement-inputSlider p1_elem_2_slider', p1_el2);
                            ...
                            p1_el2_setting.setAttribute('value', '30');
                ...
                let p1_gr2 = element('div', 'radElement-elementsGroup p1_group_2', pageHolder_1);

                let p1_el3 = element('div', 'radElement-pageElement p1_elem_3', p1_gr2);
                        ...
                        let p1_el3_input = element('input', 'radElement-pageElementInput p1_elem_3_input', p1_el3);
                            ...
                            p1_el3_input.value = '#ffffff'

                        let p1_el3_input_span = element('span', 'radElement-pageElementInputValue p1_elem_3_value', p1_el3);

                            p1_el3_input_span.innerHTML = hexToRgb(p1_el3_input.value.replace('#', '')).replace(/,/g, ' ');

                        p1_el3_input.addEventListener('input', function (event) {

                                let p1_el3_input_value = hexToRgb(p1_el3_input.value.replace('#', '')).replace(/,/g, ' ');
                                ...
                                localStorage.setItem('radiantValue-hoverBackgroundValue-hex', p1_el3_input.value);
                        ...
                        if (localStorage.getItem('radiantValue-hoverBackgroundValue')) {
                                ...
                                p1_el3_input.value = localStorage.getItem('radiantValue-hoverBackgroundValue-hex');

                        };

                let p1_el4 = element('div', 'radElement-pageElement p1_elem_4', p1_gr2);

                        let p1_el4_span = element('span', 'radElement-pageElementSpan p1_elem_4_span', p1_el4);

                            p1_el4_span.innerHTML = 'Прозрачность фона элементов (при наведении)'
                        ...
                        let p1_el4_setting = element('input', 'radElement-inputSlider p1_elem_4_slider', p1_el4);
                            ...
                            p1_el4_setting.setAttribute('value', '5');
                ...
                let p1_gr3 = element('div', 'radElement-elementsGroup p1_group_3', pageHolder_1);

                let p1_el5 = element('div', 'radElement-pageElement p1_elem_5', p1_gr3);
                        ...
                        let p1_el5_input = element('input', 'radElement-pageElementInput p1_elem_5_input', p1_el5);

                            p1_el5_input.type = 'color'

                            p1_el5_input.value = '#ffffff'

                        let p1_el5_input_span = element('span', 'radElement-pageElementInputValue p1_elem_5_value', p1_el5);

                            p1_el5_input_span.innerHTML = hexToRgb(p1_el5_input.value.replace('#', '')).replace(/,/g, ' ');

                        p1_el5_input.addEventListener('input', function (event) {

                                let p1_el5_input_value = hexToRgb(p1_el5_input.value.replace('#', '')).replace(/,/g, ' ');

                                    p1_el5_input_span.innerHTML = p1_el5_input_value

                                if (localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')) {

                                        document.body.style.cssText += `--general-outline: 1px solid rgb(${p1_el5_input_value} / ${localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')}%)`

                                } else {

                                        document.body.style.cssText += `--general-outline: 1px solid rgb(${p1_el5_input_value} / 10%)`

                                };

                                localStorage.setItem('radiantValue-defaultOutlineValue', p1_el5_input_value);

                                localStorage.setItem('radiantValue-defaultOutlineValue-hex', p1_el5_input.value);

                        })

                        if (localStorage.getItem('radiantValue-defaultOutlineValue')) {

                                p1_el5_input_span.innerHTML = localStorage.getItem('radiantValue-defaultOutlineValue');

                                p1_el5_input.value = localStorage.getItem('radiantValue-defaultOutlineValue-hex');

                        };

                let p1_el6 = element('div', 'radElement-pageElement p1_elem_6', p1_gr3);

                        let p1_el6_span = element('span', 'radElement-pageElementSpan p1_elem_6_span', p1_el6);

                            p1_el6_span.innerHTML = 'Прозрачность обводки элементов'

                        let p1_el6_setting = element('input', 'radElement-inputSlider p1_elem_6_slider', p1_el6);

                            p1_el6_setting.setAttribute('type', 'range');

                            p1_el6_setting.setAttribute('step', '1');

                            p1_el6_setting.setAttribute('min', '0');

                            p1_el6_setting.setAttribute('max', '100');

                            p1_el6_setting.setAttribute('value', '10');

                        let p1_el6_settingValue = element('span', 'radElement-pageElementInputValue p1_elem_6_value', p1_el6);

                            p1_el6_settingValue.innerHTML = `${p1_el6_setting.value}%`

                        p1_el6_setting.addEventListener('input', function() {

                                p1_el6_settingValue.innerHTML = `${p1_el6_setting.value}%`

                                if (localStorage.getItem('radiantValue-defaultOutlineValue')) {

                                        document.body.style.cssText += `--general-outline: 1px solid rgb(${localStorage.getItem('radiantValue-defaultOutlineValue')} / ${p1_el6_setting.value}%)`

                                } else {

                                        document.body.style.cssText += `--general-outline: 1px solid rgb(255 255 255 / ${p1_el6_setting.value}%)`

                                };

                                localStorage.setItem('radiantValue-defaultOutlineTransparencyValue', p1_el6_setting.value);

                        });

                        if (localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')) {

                                p1_el6_settingValue.innerHTML = `${localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')}%`

                                p1_el6_setting.value = localStorage.getItem('radiantValue-defaultOutlineTransparencyValue');

                        };

                let p1_gr4 = element('div', 'radElement-elementsGroup p1_group_4', pageHolder_1);

                let p1_el7 = element('div', 'radElement-pageElement p1_elem_7', p1_gr4);
                        ...
                        let p1_el7_input = element('input', 'radElement-pageElementInput p1_elem_7_input', p1_el7);

                            p1_el7_input.type = 'color'

                            p1_el7_input.value = '#ffffff'

                        let p1_el7_input_span = element('span', 'radElement-pageElementInputValue p1_elem_7_value', p1_el7);

                            p1_el7_input_span.innerHTML = hexToRgb(p1_el7_input.value.replace('#', '')).replace(/,/g, ' ');

                        p1_el7_input.addEventListener('input', function (event) {

                                let p1_el7_input_value = hexToRgb(p1_el7_input.value.replace('#', '')).replace(/,/g, ' ');

                                    p1_el7_input_span.innerHTML = p1_el7_input_value

                                if (localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')) {

                                        document.body.style.cssText += `--general-outline-hover: 1px solid rgb(${p1_el7_input_value} / ${localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')}%)`

                                } else {

                                        document.body.style.cssText += `--general-outline-hover: 1px solid rgb(${p1_el7_input_value} / 20%)`

                                };

                                localStorage.setItem('radiantValue-hoverOutlineValue', p1_el7_input_value);

                                localStorage.setItem('radiantValue-hoverOutlineValue-hex', p1_el7_input.value);

                        })

                        if (localStorage.getItem('radiantValue-hoverOutlineValue')) {

                                p1_el7_input_span.innerHTML = localStorage.getItem('radiantValue-hoverOutlineValue');

                                p1_el7_input.value = localStorage.getItem('radiantValue-hoverOutlineValue-hex');

                        };

                let p1_el8 = element('div', 'radElement-pageElement p1_elem_8', p1_gr4);

                        let p1_el8_span = element('span', 'radElement-pageElementSpan p1_elem_8_span', p1_el8);

                            p1_el8_span.innerHTML = 'Прозрачность обводки элементов (при наведении)'

                        let p1_el8_setting = element('input', 'radElement-inputSlider p1_elem_8_slider', p1_el8);

                            p1_el8_setting.setAttribute('type', 'range');

                            p1_el8_setting.setAttribute('value', '20');

                            p1_el8_setting.setAttribute('step', '1');

                            p1_el8_setting.setAttribute('min', '0');

                            p1_el8_setting.setAttribute('max', '100');

                            p1_el8_setting.setAttribute('value', '20');

                        let p1_el8_settingValue = element('span', 'radElement-pageElementInputValue p1_elem_8_value', p1_el8);

                            p1_el8_settingValue.innerHTML = `${p1_el8_setting.value}%`

                        p1_el8_setting.addEventListener('input', function() {

                                p1_el8_settingValue.innerHTML = `${p1_el8_setting.value}%`

                                if (localStorage.getItem('radiantValue-hoverOutlineValue')) {

                                        document.body.style.cssText += `--general-outline-hover: 1px solid rgb(${localStorage.getItem('radiantValue-hoverOutlineValue')} / ${p1_el8_setting.value}%)`

                                } else {

                                        document.body.style.cssText += `--general-outline-hover: 1px solid rgb(255 255 255 / ${p1_el8_setting.value}%)`

                                };

                                localStorage.setItem('radiantValue-hoverOutlineTransparencyValue', p1_el8_setting.value);

                        });

                        if (localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')) {

                                p1_el8_settingValue.innerHTML = `${localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')}%`

                                p1_el8_setting.value = localStorage.getItem('radiantValue-hoverOutlineTransparencyValue');
                ...
                let p1_el9 = element('div', 'radElement-pageElement p1_elem_9', pageHolder_1);
                        ...
                        let blurSetting = element('input', 'radElement-inputSlider p1_elem_9_slider', p1_el9);
                            ...
                            blurSetting.setAttribute('value', '4');
                ...
                let p2_reset = element('div', 'radElement-pageElementReset p1_reset', pageHolder_1);

                    p2_reset.innerHTML = 'Сбросить настройки'

                    p2_reset.addEventListener('click', function() {

                            localStorage.removeItem('radiantValue-defaultBackgroundValue');

                            localStorage.removeItem('radiantValue-defaultBackgroundValue-hex');

                                    p1_el1_input_span.innerHTML = '0 0 0'

                                    p1_el1_input.value = '#000000'

                            localStorage.removeItem('radiantValue-defaultBackgroundTransparencyValue');

                                    p1_el2_settingValue.innerHTML = '30%'

                                    p1_el2_setting.value = 30

                            localStorage.removeItem('radiantValue-hoverBackgroundValue');

                            localStorage.removeItem('radiantValue-hoverBackgroundValue-hex');

                                    p1_el3_input_span.innerHTML = '255 255 255'

                                    p1_el3_input.value = '#ffffff'

                            localStorage.removeItem('radiantValue-hoverBackgroundTransparencyValue');

                                    p1_el4_settingValue.innerHTML = '5%'

                                    p1_el4_setting.value = 5

                            localStorage.removeItem('radiantValue-defaultOutlineValue');

                            localStorage.removeItem('radiantValue-defaultOutlineValue-hex');

                                    p1_el5_input_span.innerHTML = '255 255 255'

                                    p1_el5_input.value = '#ffffff'

                            localStorage.removeItem('radiantValue-defaultOutlineTransparencyValue');

                                    p1_el6_settingValue.innerHTML = '10%'

                                    p1_el6_setting.value = 10

                            localStorage.removeItem('radiantValue-hoverOutlineValue');

                            localStorage.removeItem('radiantValue-hoverOutlineValue-hex');

                                    p1_el7_input_span.innerHTML = '255 255 255'

                                    p1_el7_input.value = '#ffffff'

                            localStorage.removeItem('radiantValue-hoverOutlineTransparencyValue');

                                    p1_el8_settingValue.innerHTML = '20%'

                                    p1_el8_setting.value = 20

                            localStorage.removeItem('radiantValue-blurSettingValue');

                                    blurSettingValue.innerHTML = '4px'

                                    blurSetting.value = 4

                            document.body.style.cssText = ''

                            document.body.style.cssText += `background: rgb(${localStorage.getItem('radiantValue-canvas-backgroundColor')}) !important`
                ...
                let p2_el1 = element('div', 'radElement-pageElement p2_elem_1', pageHolder_2);

                        var canvasSettings = document.createElement('style');

                            canvasSettings.className = 'radStyleSheet-canvasSettings'
                        ...
                        canvasSelectors.forEach((element) => {

                                let css = `${element.selector} {${element.style}}\n`

                                canvasSettings.textContent += css.split(`                `).join(``);

                        });

                        let p2_el1_span = element('span', 'radElement-pageElementSpan p2_elem_1_span', p2_el1);

                            p2_el1_span.innerHTML = 'Включить фоновую анимацию'

                        let p2_el1_header = element('div', 'radElement-pageElementToggle p2_elem_1_toggle', p2_el1);

                        let p2_el1_inner = element('div', 'radElement-pageElementToggleInner p2_elem_1_toggleInner', p2_el1_header);

                            p2_el1_header.addEventListener('click', () => {

                                    p2_el1_inner.classList.toggle('toggleActive');

                                    if (p2_el1_inner.classList.contains('toggleActive')) {

                                            localStorage.setItem('radiantValue-canvas-toggleValue', true);

                                            variableHeader.removeChild(canvasSettings);

                                    } else {

                                            localStorage.setItem('radiantValue-canvas-toggleValue', false);

                                            variableHeader.appendChild(canvasSettings);

                                    };

                            });

                        if (localStorage.getItem('radiantValue-canvas-toggleValue') == 'true') {

                                p2_el1_inner.classList.add('toggleActive');

                        };

                        if (localStorage.getItem('radiantValue-canvas-toggleValue') == 'false' || !localStorage.getItem('radiantValue-canvas-toggleValue')) {
                ...
                let p2_el2 = element('div', 'radElement-pageElement p2_elem_2', pageHolder_2);
                        ...
                        let p2_el2_setting = element('input', 'radElement-inputSlider p2_elem_2_slider', p2_el2);
                            ...
                            p2_el2_setting.setAttribute('value', '3');
                ...
                let p2_el3 = element('div', 'radElement-pageElement p2_elem_3', pageHolder_2);
                        ...
                        let p2_el3_setting = element('input', 'radElement-inputSlider p2_elem_3_slider', p2_el3);
                            ...
                            p2_el3_setting.setAttribute('value', '200');
                ...
                let p2_el4 = element('div', 'radElement-pageElement p2_elem_4', pageHolder_2);
                        ...
                        let p2_el4_setting = element('input', 'radElement-inputSlider p2_elem_4_slider', p2_el4);
                            ...
                            p2_el4_setting.setAttribute('value', '30');
                ...
                let p2_el5 = element('div', 'radElement-pageElement p2_elem_5', pageHolder_2);
                        ...
                        let p2_el5_setting = element('input', 'radElement-inputSlider p2_elem_5_slider', p2_el5);
                            ...
                            p2_el5_setting.setAttribute('value', '0.4');
                ...
                let p2_el6 = element('div', 'radElement-pageElement p2_elem_6', pageHolder_2);

                        let p2_el6_span = element('span', 'radElement-pageElementSpan p2_elem_6_span', p2_el6);

                            p2_el6_span.innerHTML = 'Цвет фона'

                        let p2_el6_input = element('input', 'radElement-pageElementInput p2_elem_6_input', p2_el6);

                            p2_el6_input.type = 'color'

                            p2_el6_input.value = '#000000'

                        let p2_el6_input_span = element('span', 'radElement-pageElementInputValue p2_elem_6_value', p2_el6);

                            p2_el6_input_span.innerHTML = hexToRgb(p2_el6_input.value.replace('#', '')).replace(/,/g, ' ');

                        p2_el6_input.addEventListener('input', function (event) {

                                let p2_el6_input_value = hexToRgb(p2_el6_input.value.replace('#', '')).replace(/,/g, ' ');

                                    p2_el6_input_span.innerHTML = p2_el6_input_value

                                document.body.style.cssText += `background: rgb(${p2_el6_input_value}) !important`

                                localStorage.setItem('radiantValue-canvas-backgroundColor', p2_el6_input_value);

                                localStorage.setItem('radiantValue-canvas-backgroundColor-hex', p2_el6_input.value);

                        })

                        if (localStorage.getItem('radiantValue-canvas-backgroundColor')) {

                                p2_el6_input_span.innerHTML = localStorage.getItem('radiantValue-canvas-backgroundColor');

                                p2_el6_input.value = localStorage.getItem('radiantValue-canvas-backgroundColor-hex');

                        };

                let p2_el7 = element('div', 'radElement-pageElement p2_elem_7', pageHolder_2);

                        let p2_el7_span = element('span', 'radElement-pageElementSpan p2_elem_7_span', p2_el7);

                            p2_el7_span.innerHTML = 'Цвет линий'

                        let p2_el7_input = element('input', 'radElement-pageElementInput p2_elem_7_input', p2_el7);

                            p2_el7_input.type = 'color'

                            p2_el7_input.value = '#ffffff'

                        let p2_el7_input_span = element('span', 'radElement-pageElementInputValue p2_elem_7_value', p2_el7);

                            p2_el7_input_span.innerHTML = hexToRgb(p2_el7_input.value.replace('#', '')).replace(/,/g, ' ');

                        p2_el7_input.addEventListener('input', function (event) {

                                let p2_el7_input_value = hexToRgb(p2_el7_input.value.replace('#', '')).replace(/,/g, ' ');

                                    p2_el7_input_span.innerHTML = p2_el7_input_value

                                localStorage.setItem('radiantValue-canvas-linesColor', p2_el7_input_value);

                                localStorage.setItem('radiantValue-canvas-linesColor-hex', p2_el7_input.value);

                        })

                        if (localStorage.getItem('radiantValue-canvas-linesColor')) {

                                p2_el7_input_span.innerHTML = localStorage.getItem('radiantValue-canvas-linesColor');

                                p2_el7_input.value = localStorage.getItem('radiantValue-canvas-linesColor-hex');

                        };

                let p2_tip = element('div', 'radElement-pageElementTip p2_tip', pageHolder_2);

                    p2_tip.innerHTML = 'Для применения настроек необходимо перезагрузить страницу'
                ...
                let pageHolder_5 = element('div', 'radElement-pageHolder pge_5', pageHeader);
                        ...
                        let p5_el1_header = element('h1', 'radElement-pageElementText p5_elem_1_header', pageHolder_5);

                            p5_el1_header.innerHTML = 'Описание проекта'

                        let p5_el1_text = element('span', 'radElement-pageElementText p5_elem_1_text', pageHolder_5);

                            p5_el1_text.innerHTML = 'Radiant — кастомная тема на Танки Онлайн, которая предоставляет расширенное взаимодействие напрямую с пользовательским интерфейсом и элементами дизайна. Была проделана большая работа по улучшению качества, переосмыслению базового UI и UX, обновлению непосредственно визуальной составляющей игры. Среди ключевых нововведений: оформление отдельной страницы в лобби с настройками для кастомизации интерфейса; реализация возможности гибкой настройки элементов на странице посредством JS и CSS (цвет, прозрачность, обводка, изменение фона страницы/анимации фона); обновленные иконки и анимации; создание множества полезных функций, призванных улучшить опыт (быстрые режимы в лобби, постоянное отображение резистов во внутриигровом окне статистики, отдельная вкладка в гараже с сохраненными сочетаниями пушек, корпусов, дронов, модулей) и другие. Проект регулярно оптимизируется и совершенствуется с учетом пожеланий и замечаний игроков. Связаться с разработчиком можно по данным на этой странице.'

                        let p5_el2_text = element('span', 'radElement-pageElementText p5_elem_2_text', pageHolder_5);

                            p5_el2_text.innerHTML = 'Discord разработчика:'

                        let p5_el3_text = element('span', 'radElement-pageElementText p5_elem_3_text', pageHolder_5);

                            p5_el3_text.innerHTML = '@triplesixmode'

                        let p5_el4_text = element('span', 'radElement-pageElementText p5_elem_4_text', pageHolder_5);

                            p5_el4_text.innerHTML = 'Discord-сервер с проектами:'

                        let p5_el5_text = element('a', 'radElement-pageElementText p5_elem_5_text', pageHolder_5);

                            p5_el5_text.innerHTML = 'Ссылка'

                            p5_el5_text.setAttribute('href', 'https://discord.gg/eBqHtytHDg');

                            p5_el5_text.target = '_blank'

                        let p5_el6_text = element('span', 'radElement-pageElementText p5_elem_6_text', pageHolder_5);

                            p5_el6_text.innerHTML = `Текущая версия: ${version}`
        };
                ...
                (function () {
                        ...
                        Waves.prototype.updateColor = function () {
                                ...
                                if (localStorage.getItem('radiantValue-canvas-linesColor')) {
                                    ...
                                    Waves.color = `rgb(${localStorage.getItem('radiantValue-canvas-linesColor')} / 2.5%)`
                        ...
                        if (window.location.href.includes(link) == true) {
                                ...
                                if (localStorage.getItem('radiantValue-defaultOutlineValue')) {
                                        ...
                                        if (localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')) {
                                                ...
                                                document.body.style.cssText += `--general-outline: 1px solid rgb(${localStorage.getItem('radiantValue-defaultOutlineValue')} / ${localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')}%)`

                                        } else {

                                                document.body.style.cssText += `--general-outline: 1px solid rgb(${localStorage.getItem('radiantValue-defaultOutlineValue')} / 10%)`
                                ...
                                if (localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')) {
                                        ...
                                        if (localStorage.getItem('radiantValue-defaultOutlineValue')) {
                                                ...
                                                document.body.style.cssText += `--general-outline: 1px solid rgb(255 255 255 / ${localStorage.getItem('radiantValue-defaultOutlineTransparencyValue')}%)`
                                ...
                                if (localStorage.getItem('radiantValue-hoverOutlineValue')) {
                                        ...
                                        if (localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')) {
                                                ...
                                                document.body.style.cssText += `--general-outline-hover: 1px solid rgb(${localStorage.getItem('radiantValue-hoverOutlineValue')} / ${localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')}%)`

                                        } else {

                                                document.body.style.cssText += `--general-outline-hover: 1px solid rgb(${localStorage.getItem('radiantValue-hoverOutlineValue')} / 20%)`
                                ...
                                if (localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')) {
                                        ...
                                        if (localStorage.getItem('radiantValue-hoverOutlineValue')) {
                                                ...
                                                document.body.style.cssText += `--general-outline-hover: 1px solid rgb(255 255 255 / ${localStorage.getItem('radiantValue-hoverOutlineTransparencyValue')}%)`
                                                        ...
                                                        Mutation.addedNodes.forEach(function(element) {
                                                                ...
                                                                if (element.nodeType === 1 && element.classList.contains('-container')) {
                                                                        ...
                                                                        if (nicknameHeader) {
                                                                                ...
                                                                                localStorage.setItem('radiant-nickname', nickname);

                                                                        };

                                                                        let rankHeader = document.querySelector('.UserInfoContainerStyle-titleRankIcon');

                                                                        if (rankHeader) {

                                                                                var rank = rankHeader.src

                                                                                localStorage.setItem('radiant-rank', rank);
